...
const Banner = () => {
      return (
            <section className=' md:pt-space120 border-2 border-red-500 flex flex-col justify-center items-center lg:pt-space120 '>
                  <img src="/public/Vector.svg" className=' bg-success/0 sticky -z-20 lg:top-24  border-2 border-red-500  w-56 md:w-96 top-[50%] -translate-y-1/2 block' alt="" />
                  ...
                  <p className='text-center md:py-space15 py-spacelg lg:py-space15 font-primaryLight md:text-textSmall text-mobiletextSmall lg:text-textSmall mix-blend-difference text-success'>(Scroll to Explore)</p>
                  </div>
                  </div>
                  <NavadwipMeaning/>
                  <IlandImages/>
