...
const Banner = () => {
      return (
            <section id='topContainer' className=' md:pt-space120 flex flex-col justify-center items-center '>
                  ...
                  <h1 className='absolute uppercase text-[15vw] font-primaryLight  md:tracking-normal  z-20 mix-blend-difference text-success  top-[50%] -translate-y-1/2 block text-center '>Navadvip</h1>
                  <div className=''>
