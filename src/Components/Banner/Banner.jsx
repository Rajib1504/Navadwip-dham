...
const Banner = () => {
      return (
            <section className=' md:pt-space120 flex flex-col justify-center items-center lg:pt-space120 '>
                  ...
                  <h1 className='absolute uppercase text-mobileHero md:text-heading1 font-primaryLight  md:tracking-normal  z-20 mix-blend-difference text-success  top-[50%] -translate-y-1/2 block w-full text-center '>Navadvip</h1>
                  <div className=''>
