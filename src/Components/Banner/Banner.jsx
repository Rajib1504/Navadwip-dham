...
const Banner = () => {
      return (
            <div className=' md:pt-space120 lg:pt-space120 '>
                  ...
                  <h1 className='absolute top-44 lg:top-96 md:top-96 uppercase lg:left-[28%] md:left-[13%]   text-[72px] md:text-heading lg:text-heading1 font-primaryLight tracking-wide md:tracking-wider lg:tracking-wider left-[6%] z-20 mix-blend-difference text-success '>Navadvip</h1>
      ...
      //         className="absolute w-80 md:w-96 lg:w-auto mix-blend-difference"
      //         alt="Navadvip Vector"
      //       />
      
      //       {/* Text Content */}
      //       <h1 className="absolute text-6xl md:text-8xl lg:text-9xl font-light uppercase tracking-widest  mix-blend-difference">
      //         Navadvip
      //       </h1>
      
      //       <div className="absolute bottom-20 text-center">
      //         <h4 className="text-lg md:text-xl text-black mix-blend-difference">
      //           The Most Sacred Place in the World
      //         </h4>
      //         <p className="text-sm md:text-base text-white mix-blend-difference">
      //           (Scroll to Explore)
      //         </p>
      //       </div>
      //     </div>
