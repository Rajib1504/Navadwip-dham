...
const Banner = () => {
      return (
            <div className=' md:pt-space120 lg:pt-space120 '>
                  ...
                  <h1 className='absolute top-44 lg:top-96 md:top-96 uppercase lg:left-[28%] md:left-[13%]   text-heading2 md:text-heading lg:text-heading1 font-primaryLight tracking-widest left-[5%] md:tracking-wider   z-20 mix-blend-difference text-success lgMobile:left-[11%] smMobile:left-[2%] '>Navadvip</h1>
