          ...
          <div className="md:grid  grid-cols-12">
            ...
            <div className="self-center  md:mt-0  mt-space60  col-start-5 col-span-5 text-mobileTextRegular md:text-textRegular font-primaryLight">
              <p className="paragraph ">
                ...
                shining like gold. Overcome with joy, she bowed at His feet and
                placed their dust on the parting of her hair, called simanta.
                And so, this island became known as Simantadvip.
              </p>
              <p className="paragraph mt-space15 md:mt-space30">
                But why was Parvati so eager to see Sri Chaitanya? The answer
                lies with Shiva. In ancient times, he danced and chanted in
                great ecstasy. When Parvati asked the reason, he revealed a
                secret: one day, Sri Chaitanya would come to Navadvip, spreading
                divine love through the chanting of the Holy Names. Just hearing
                this, Shiva was overwhelmed with bliss and longed to go there
                himself.
              </p>
              <p className="paragraph mt-space15 md:mt-space30">
                Inspired, Parvati set out for Navadvip, determined to receive
                Bhagavan’s mercy. Her devotion was rewarded, and when she
                finally saw Sri Chaitanya, her heart overflowed. She placed the
                dust of His feet on her simanta, and from that moment, the
                island bore the name Simantadvip.
              </p>
            </div>
          </div>
        </div>
