        ...
        <div className=" col-start-5 col-span-5  w-full ">
          ...
          <div className="my-space60 text-mobileTextRegular md:text-textRegular md:my-space120 ">
            <p className=" paragraph mb-space15 md:mb-space30">
              ...
              world-renowned spiritual master, Srila Prabhupad Bhakti Siddhanta
              Saraswati Goswami Thakur—the foremost preacher of Sri Chaitanya’s
              message.{" "}
            </p>
            <p className=" paragraph mb-space15 md:mb-space30">
            ...
            <p className=" paragraph mb-space15 md:mb-space30">
              ...
              him as “volcanic energy.” After Srila Prabhupad’s departure, Srila
              Madhav Maharaj played a crucial role in uniting his godbrothers to
              continue spreading Sri Chaitanya’s teachings.
            </p>
          </div>
        </div>
      </div>
