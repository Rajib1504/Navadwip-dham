...
const NandanAcharyaBhavan = () => {
  return (
    <section id="nandan-acharya-bhavan">
      <div
        id="2"
        ...
        <div className="col-start-5 col-span-5  w-full  ">
          ...
          <div className=" paragraph my-space60 text-mobileTextRegular md:text-textRegular md:my-space120 ">
            <p className="paragraph mb-space15 md:mb-space30">
              ...
              associate of Sri Chaitanya. Sri Chaitanya met Nityananda Prabhu at
              this very place for the first time.
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
              One day, Sri Chaitanya understood that Nityananda had arrived in
              Navadvip. Overwhelmed with joy, He urged His devotees to find Him.
              But no one knew whom He was speaking about.
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
            ...
            <p className="paragraph mb-space15 md:mb-space30">
              "He asked repeatedly, ‘Is this the house of Nimai Pandit?’ Though
              I had never seen Him before, I was drawn to Him with deep
              reverence. I asked, ‘Who are You?’ He smiled and said, ‘I am Your
              brother. Tomorrow, we shall meet.’
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
              "I believe a great soul has arrived in Navadvip. Haridas! Shrivas!
              Go find Him at once."
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
              Haridas Thakur and Shrivas Pandit searched everywhere but found no
              one like the person Chaitanya described. After nine hours, they
              returned, exhausted: "We searched every corner of Navadvip but
              could not find Him."
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
            ...
            <p className="paragraph mb-space15 md:mb-space30">
              ...
              Nityananda. Chanting “Haribol! Haribol!”, they arrived at Nandana
              Acharya’s house.
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
            ...
            <p className="paragraph mb-space15 md:mb-space30">
              ...
              flowers on His ears, a golden-yellow garment, and the Vaijayanti
              garland, Lord Krishna entered Vrindavan, filling the forest with
              the nectar of His flute…"
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
              Upon hearing this, Nityananda collapsed in divine ecstasy, losing
              all external awareness. As Shrivas recited more and more, His
              bliss intensified—He roared, tears streaming down His face. The
              Lord and His brother had reunited.
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
              Today, this sacred site is home to a beautiful temple, established
              by Srila Bhakti Saranga Goswami Maharaj, a prominent disciple of
              Srila Prabhupad. Here, he installed the deities of Sri Sri
              Gaura-Nityananda, Sri Sri Radha Vinod Bihari, Sriman Sri
              Chaitanya, and Sri Narasimha Dev.
            </p>
            <p className="paragraph mb-space15 md:mb-space30">
              Srila Bhakti Saranga Maharaj was a distinguished scholar, a
              brilliant orator, and an exceptional preacher. His deep wisdom and
              divine qualities made him a master at dispelling misconceptions
              and defending the mission of Sri Chaitanya. Recognizing his
              abilities, Srila Prabhupad often entrusted him with clarifying
              doubts and upholding the integrity of the Gaudiya mission—a task
              he fulfilled with great success.
            </p>
...
export default NandanAcharyaBhavan;
