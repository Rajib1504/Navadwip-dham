...
const SvanandaSukhandaKunja = () => {
      return (
        <section id='svananda-sukhada-kunja'>
            ...
            {/* images   */}
            <LayoutB
            img1={"/public/islands/03-godrumdvip/01-svananda-sukhanda-kunja/1-svananda-sukhanda-kunja.jpg"}
            img2={"/public/islands/03-godrumdvip/01-svananda-sukhanda-kunja/2-svananda-sukhanda-kunja.jpg"}
            img3={"/public/islands/03-godrumdvip/01-svananda-sukhanda-kunja/3-bhaktivinod-svananda-sukhanda-kunja.jpg"}
            />
