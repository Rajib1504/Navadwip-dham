...
const SurabhiKunja = () => {
      return (
        <section id='surabhi-kunja'>
          ...
          {/* images   */}
       <LayoutB
      img1={"/public/islands/03-godrumdvip/02-surabhi-kunja/1-surabhi-kunja.jpg"}
      img2={"/public/islands/03-godrumdvip/02-surabhi-kunja/2-surabhi-kunja-mandir.jpg"}
      img3={"/public/islands/03-godrumdvip/02-surabhi-kunja/3-surabhi-kunja.jpg"}
      />
