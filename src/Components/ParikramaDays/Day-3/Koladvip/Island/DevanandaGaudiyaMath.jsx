              ...
              <div className="col-start-5 col-span-5  w-full mr-space30 ">
                ...
                <div className="my-space60 text-mobileTextRegular md:text-textRegular md:my-space120 ">
                  <p className="mb-space15 md:mb-space30">
                    ...
                    cherished desire of his spiritual master, Srila Prabhupad
                  ...
                  <p className="mb-space15 md:mb-space30">
                    The temple’s nine towers symbolize the nine types of
                    devotional service. Additionally, its samadhi mandir is
                    situated near the main hall, directly in front of the temple.
                  </p>
                </div>
              </div>
            </div>
