...
const PrayudhaMaya = () => {
      return (
        <section id='prayudha-maya'>
            ...
            {/* images   */}
          <LayoutA
          img1={"/public/islands/05-koladvip/01-prauda-maya/1-prauda-maya.jpg"}
          img2={"/public/islands/05-koladvip/01-prauda-maya/2-prauda-maya-mandir.jpg"}
          img3={"/public/islands/05-koladvip/01-prauda-maya/4-prauda-maya-murti.jpg"}
          />
