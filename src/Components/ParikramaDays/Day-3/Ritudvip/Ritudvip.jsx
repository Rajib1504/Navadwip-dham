    ...
    <div className="pt-space120 md:pt-space300 ">
      <article className="w-11/12 mx-auto  ">
        <section className="md:grid grid-cols-12 ">
          ...
          <h2 id="Ritudvip" className="font-primaryLight col-start-4 col-span-6  md:text-heading1 text-mobileheading1 text-center mb-space120 md:mb-space240">
            Ritudvip
          </h2>
            ...
            <div className="col-start-5 col-span-6  w-full mr-space30 ">
              ...
              <div className="my-space60 text-mobileTextRegular md:text-textRegular md:my-space120 ">
                <p className="mb-space15 md:mb-space30">
                  ...
                  Like a cowherd boy, he suddenly called for a horn to gather
                  the cows, overcome with longing for Sri Krishna and His
                  companions.
                </p>
                <p className="mb-space15 md:mb-space30">
                  When the devotees reminded him that Sri Chaitanya had taken
                  sannyasa and departed for Nilachal, Nityananda collapsed in
                  sorrow, rolling in the dust with tears streaming down his
                  face. For over an hour, he remained in deep ecstasy, appearing
                  as if he had lost all desire to live.
                </p>
                <p className="mb-space15 md:mb-space30">
        ...
        <div>
          ...
          >
            ...
            <div className="col-start-5 col-span-6  w-full mr-space30 ">
              <h4 className="text-mobileheading2 md:text-heading2 font-primaryLight mb-spacelg">
                Nandan Acharya BhavanVidyanagar
              </h4>
              <p className="text-mobileTextRegular md:text-textRegular">
