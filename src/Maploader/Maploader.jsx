...
const MapPreloader = ({ onComplete }) => {
  ...
  return (
    <div
      id="map-preloader"
      className="fixed inset-0 z-[9999] bg-[#1C1B1B] overflow-hidden"
    >
      {/* Map Drawing Container */}
      <div class="container">
        <div class="loader w-[60%] md:w-[30%]">
          <svg
            ref={svgRef}
            aria-hidden="true"
